...
file dump. You have done this before and will do it again, under every line describe key points to take away.
In your description be sure to name the frameworks and packages assoicated being used and any potential bugs"
